...
def run_detector(detector, path, amount):
  ...
  vals = result['detection_scores']
  paired_results= list(zip(keys,vals ))
  print(paired_results)
  


def detect_img(detector, image_url, amount):
  image_path = download_and_resize_image(image_url, 640, 480)
  run_detector(detector, image_path, amount)
...
def main(url, amount):
  if valid_image_ext(url):
    ...
    detect_img(detector, url, amount)
  else:
